...
def sobreposicao_contar_posicoes_permitidas(matriz, palavra, indice_letra_na_palavra, linha, coluna):
...
def sobreposicao_verificar_lado_direito(matriz, palavra, tamanho_palavra_direita, indice_letra_na_palavra, linha, coluna, posicao, palavra_invertida):
    ...
    for indice in range(0, tamanho_palavra_direita): # percorrendo a quantidade de letras do lado direito da palavra
        ...
        if(sobreposicao_contar_posicoes_permitidas(matriz, palavra, indice_letra_na_palavra, linha, coluna)): # verificar se a posição é permitida
...
def sobreposicao_verificar_lados(matriz, palavra, tamanho_palavra_esquerda, tamanho_palavra_direita, indice_letra_na_palavra, linha, coluna, posicao, palavra_invertida):
    if(palavra_invertida): # caso a palavra seja invertida
    ...
    if( # verificando se ambos os lados da palavra se encaixam na matriz
        sobreposicao_verificar_lado_esquerdo(matriz, palavra, tamanho_palavra_esquerda, indice_letra_na_palavra, linha, coluna, posicao, palavra_invertida) # verificar se o lado esquerdo da palavra é permitido
        and
        sobreposicao_verificar_lado_direito(matriz, palavra, tamanho_palavra_direita, indice_letra_na_palavra, linha, coluna, posicao, palavra_invertida) # verificar se o lado direito da palavra é permitido
      ):
...
def sobreposicao_obter_posicoes(matriz, palavras, palavra, letra_na_matriz, linha, coluna):
    ...
    for indice in range(0, palavras[palavra]["letras"][letra_na_matriz]): # percorrendo a quantidade de vezes que a letra existe na palavra
        ...
        for posicao in lista_de_posicoes: # percorrendo as posições
            if(sobreposicao_verificar_lados(matriz, palavra, tamanho_palavra_esquerda, tamanho_palavra_direita, indice_letra_na_palavra, linha, coluna, posicao, palavra_invertida = lista_de_posicoes[posicao])): # verificar se a posição permite sobreposição
